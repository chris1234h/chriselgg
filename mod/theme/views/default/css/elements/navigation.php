...
.elgg-menu-site-default > li:hover > a {
	background: #00ffff url(<?php echo elgg_get_site_url(); ?>mod/ac-130/images/menu-button.png) repeat-x left top;
	color: #05d;
...
.elgg-menu-hover {
	...
	-webkit-box-shadow: 0px 2px 5px rgba(0, 0, 255, 0.5);
	-moz-box-shadow: 0px 2px 5px rgba(0, 0, 255, 0.5);
